                    ...
                    if category == "prompt":
                        ...
                        with FormRow():
                            with gr.Column(elem_id="txt2img_column_size", scale=4):
                                width = gr.Slider(minimum=64, maximum=4092, step=16, label="Width", value=512, elem_id="txt2img_width")
                                height = gr.Slider(minimum=64, maximum=4092, step=16, label="Height", value=512, elem_id="txt2img_height")
                        ...
                        with gr.Row(elem_id="txt2img_accordions", elem_classes="accordions"):
                            with InputAccordion(False, label="Hires. fix", elem_id="txt2img_hr") as enable_hr:
                                ...
                                with FormRow(elem_id="txt2img_hires_fix_row2", variant="compact"):
                                    ...
                                    hr_resize_x = gr.Slider(minimum=0, maximum=4092, step=8, label="Resize width to", value=0, elem_id="txt2img_hr_resize_x")
                                    hr_resize_y = gr.Slider(minimum=0, maximum=4092, step=8, label="Resize height to", value=0, elem_id="txt2img_hr_resize_y")
                            ...
                            with gr.Column(elem_id="img2img_column_size", scale=4):
                                ...
                                with gr.Tabs(elem_id="img2img_tabs_resize"):
                                    with gr.Tab(label="Resize to", id="to", elem_id="img2img_tab_resize_to") as tab_scale_to:
                                        with FormRow():
                                            with gr.Column(elem_id="img2img_column_size", scale=4):
                                                width = gr.Slider(minimum=64, maximum=4092, step=8, label="Width", value=512, elem_id="img2img_width")
                                                height = gr.Slider(minimum=64, maximum=4092, step=8, label="Height", value=512, elem_id="img2img_height")
        ...
        with ResizeHandleRow(variant="compact", equal_height=False):
            with gr.Tabs(elem_id="train_tabs"):
                ...
                with gr.Tab(label="Train", id="train"):
                    ...
                    training_width = gr.Slider(minimum=64, maximum=4092, step=8, label="Width", value=512, elem_id="train_training_width")
                    training_height = gr.Slider(minimum=64, maximum=4092, step=8, label="Height", value=512, elem_id="train_training_height")
